###############global########################
# config for laion-high-aesthetics_6: 17w
# global_batch_size = 2(batch_size) * 32(gradient_accumulation_steps) * 32(gpus)  = 2048
# so we have num_batch_size = 16w/2k = 80
# set test_freq to 80, which is about steps per echo  
...
###############DataLoader#####################
num_workers = 2  # number of dataloader processes per GPU(process)
